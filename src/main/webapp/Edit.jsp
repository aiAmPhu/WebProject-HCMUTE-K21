                    ...
                    <div class="modal-content">
                        <form action="edit" method="post">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    <label>Image</label>
                                    <input value="${detail.images}" name="image" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Brand</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="${detail.nutritionalValue}" name="nutrivalue" type="text" class="form-control" required>
                                </div>
