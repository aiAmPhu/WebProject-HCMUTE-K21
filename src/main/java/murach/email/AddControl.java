...
public class AddControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int pid=product.getMaxProductID()+1;
        ...
        String nutritionalvalue=request.getParameter("nutritionalvalue");
        float nutriFloat = Float.parseFloat(nutritionalvalue);
        Product p=new Product();
        p.setProductID(pid);
        p.setProductName(name);
        p.setPrice(priceFloat);
        p.setDescription(description);
        p.setImages(image);
        p.setBrand(brand);
        p.setCategory(category);
        p.setWeight(weightFloat);
        p.setNutritionalValue(nutriFloat);
